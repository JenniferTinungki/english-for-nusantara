            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div class="md:col-span-6">
                    ...
                    <input type="text" name="name" 
                        ...
                        value="{{ old('name', $user->name) }}" placeholder="Nama lengkap siswa">
                ...
                <div class="md:col-span-6">
                    ...
                    <input type="text" name="nis" 
                        ...
                        value="{{ old('nis', $user->nis) }}" placeholder="Nomor Induk Siswa">
                ...
                <div class="md:col-span-4">
                    ...
                    <input type="text" name="kelas" 
                        ...
                        value="{{ old('kelas', $user->kelas) }}" placeholder="Contoh: X IPA 1">
                ...
                <div class="md:col-span-6">
                    ...
                    <input type="email" name="email" 
                        ...
                        value="{{ old('email', $user->email) }}" placeholder="email@siswa.sch.id">
