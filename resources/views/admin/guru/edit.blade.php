...
<div class="space-y-6">
    ...
    <div>
        ...
        <h1 class="text-3xl font-extrabold tracking-tight text-slate-800">Edit Data Guru</h1>
        <p class="text-slate-500 font-medium">Mengubah data: <span class="text-blue-600">{{ $user->name }}</span></p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div class="md:col-span-6">
                    ...
                    <input type="text" name="name"
                        class="w-full px-4 py-2.5 bg-slate-50 border @error('name') border-red-400 @else border-slate-200 @enderror rounded-xl focus:ring-2 focus:ring-blue-500 outline-none"
                        value="{{ old('name', $user->name) }}" placeholder="Nama lengkap guru">
                ...
                <div class="md:col-span-4 flex items-center md:items-end pb-1">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="is_active" id="is_active" value="1" class="sr-only peer" @checked(old('is_active', $user->is_active))>
                ...
                <div class="md:col-span-6">
                    ...
                    <input type="email" name="email"
                        ...
                        value="{{ old('email', $user->email) }}" placeholder="email@guru.sch.id">
