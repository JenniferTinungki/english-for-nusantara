    ...
    <div class="relative overflow-hidden rounded-[34px]">
                ...
                <div class="relative z-10 h-full flex flex-col justify-between">
                    ...
                    <div class="mt-8 flex flex-wrap items-center gap-3 text-sm text-blue-100">
                        <div class="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 border border-white/15">
                            ...
                            {{ $totalMateriCount }} Materi
                        </div>
                        <div class="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 border border-white/15">
                            <i class="fa-solid fa-circle-check"></i>
                            {{ $quizSelesaiCount }} Quiz Selesai
                        </div>
                        <div class="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 border border-white/15">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4 mb-8">
            <div class="rounded-[26px] border border-slate-200/70 bg-white/90 backdrop-blur-xl p-5 shadow-[0_15px_45px_rgba(15,23,42,0.06)] hover:-translate-y-1 transition">
                ...
                <h3 class="text-4xl font-black text-slate-800">{{ $totalMateriCount }}</h3>
            ...
            <div class="rounded-[26px] border border-slate-200/70 bg-white/90 backdrop-blur-xl p-5 shadow-[0_15px_45px_rgba(15,23,42,0.06)] hover:-translate-y-1 transition">
                ...
                <h3 class="text-4xl font-black text-slate-800">{{ $quizSelesaiCount }}</h3>
            ...
            <div class="rounded-[26px] border border-slate-200/70 bg-white/90 backdrop-blur-xl p-5 shadow-[0_15px_45px_rgba(15,23,42,0.06)] hover:-translate-y-1 transition">
                ...
                <h3 class="text-4xl font-black text-slate-800">{{ $totalTugasCount }}</h3>
            ...
            <div class="rounded-[26px] border border-slate-200/70 bg-white/90 backdrop-blur-xl p-5 shadow-[0_15px_45px_rgba(15,23,42,0.06)] hover:-translate-y-1 transition">
                ...
                <h3 class="text-4xl font-black text-slate-800">{{ $totalAssessmentCount }}</h3>
            ...
            <div class="rounded-[26px] border border-slate-200/70 bg-white/90 backdrop-blur-xl p-5 shadow-[0_15px_45px_rgba(15,23,42,0.06)] hover:-translate-y-1 transition">
                ...
                <h3 class="text-4xl font-black text-slate-800">{{ $progress }}%</h3>
                    ...
                    <div class="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 h-full">
                        <div class="max-w-2xl">
                            ...
                            <h2 class="text-3xl md:text-4xl font-extrabold mb-4 leading-tight">
                                {{ $materiTerbaru->judul ?? 'Belum ada materi terbaru' }}
                            </h2>

                            <p class="text-blue-100 text-lg leading-8 mb-6">
                                {{ $materiTerbaru->deskripsi ?? 'Materi terbaru akan muncul di sini.' }}
                            </p>

                            @if(isset($materiTerbaru))
                                <div class="flex flex-wrap gap-3">
                                    <a href="{{ route('siswa.materi.show', $materiTerbaru->id) }}"
                        ...
                        <div class="w-full lg:w-60">
                            <div class="rounded-[28px] bg-white/10 border border-white/20 backdrop-blur-xl p-6 text-center">
                                ...
                                <div class="text-5xl font-black">{{ $progress }}%</div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-slate-500 mt-1">
                                                Deadline:
                                                {{ $tugas->deadline ? \Carbon\Carbon::parse($tugas->deadline)->format('d M Y • H:i') : 'Tidak ditentukan' }}
                                            </p>
                                        </div>
                                    </div>
                ...
                <div class="rounded-[30px] border border-slate-200/70 bg-white/90 backdrop-blur-xl p-6 lg:p-8 shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div class="rounded-2xl bg-slate-50 border border-slate-100 p-4">
                            ...
                            <h4 class="text-3xl font-extrabold text-slate-800 mt-2">{{ $totalMateriCount }}</h4>
                        </div>

                        <div class="rounded-2xl bg-slate-50 border border-slate-100 p-4">
                            <p class="text-sm text-slate-500">Quiz Selesai</p>
                            <h4 class="text-3xl font-extrabold text-slate-800 mt-2">{{ $quizSelesaiCount }}</h4>
                        </div>

                        <div class="rounded-2xl bg-slate-50 border border-slate-100 p-4">
                            <p class="text-sm text-slate-500">Tugas</p>
                            <h4 class="text-3xl font-extrabold text-slate-800 mt-2">{{ $totalTugasCount }}</h4>
                        </div>

                        <div class="rounded-2xl bg-slate-50 border border-slate-100 p-4">
                            <p class="text-sm text-slate-500">Assessment</p>
                            <h4 class="text-3xl font-extrabold text-slate-800 mt-2">{{ $totalAssessmentCount }}</h4>
                        </div>
                    </div>
                </div>
            </div>
