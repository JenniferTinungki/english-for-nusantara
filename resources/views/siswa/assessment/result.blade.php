        ...
        <div class="result-shell">
            <div class="result-hero">
                <div class="row align-items-center g-4">
                    <div class="col-lg-8">
                        ...
                        <h1 class="result-title">{{ $attempt->assessment->title }}</h1>
                    ...
                    <div class="col-md-4">
                        <div class="stat-card">
                            ...
                            <div class="stat-value">
                                ...
                                @else
                                    <span class="status-pill status-neutral">{{ ucfirst($attempt->status) }}</span>
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            <div class="answers-section">
                        ...
                        <div class="answer-card-top">
                            <div class="answer-left">
                                ...
                                <div>
                                    ...
                                    <div class="question-meta">Soal nomor {{ $index + 1 }}</div>
                                </div>
                            </div>
                        ...
                        <div class="row g-3 mt-1">
                            <div class="col-md-6">
                                <div class="answer-box">
                                    ...
                                    <div class="answer-box-value">{{ $answer->jawaban_siswa ?? '-' }}</div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="answer-box">
                                    ...
                                    <div class="answer-box-value">{{ $answer->question->correct_answer ?? '-' }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bottom-action">
                    <a href="{{ route('siswa.assessment.index') }}" class="btn btn-primary rounded-pill px-4 py-2">
