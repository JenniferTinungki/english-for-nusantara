...
<div class="container-fluid py-4 px-3">
    ...
    <div class="result-shell">
        <div class="hero">
            <div class="hero-title">{{ $attempt->quiz->judul }}</div>
            <p class="hero-sub">Quiz selesai. Berikut hasil pengerjaanmu.</p>
        </div>

        <div class="card-box text-center">
            <div class="score mb-2">{{ $attempt->score }}</div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    <div class="border rounded-4 p-3">
                        ...
                        <div>{{ $attempt->correct_answers }}</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="border rounded-4 p-3">
                        <div class="fw-bold">Total Soal</div>
                        <div>{{ $attempt->total_questions }}</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="border rounded-4 p-3">
                        <div class="fw-bold">Chapter</div>
                        <div>{{ $attempt->quiz->chapter }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-center">
                ...
                <a href="{{ route('siswa.quiz.show', $attempt->quiz->id) }}" class="btn btn-primary btn-premium">
                    Kerjakan Lagi
                </a>
                <a href="{{ route('siswa.quiz.leaderboard', $attempt->quiz->id) }}" class="btn btn-outline-primary btn-premium">
                    Leaderboard
                </a>
            </div>
        </div>
