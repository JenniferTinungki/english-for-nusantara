...
@section('title', 'Tugas - ' . ($tugas->judul ?? 'Tanpa Judul'))
            ...
            <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                <div class="max-w-3xl">
                    ...
                    <p class="text-white/85 text-base md:text-lg leading-8">
                        {{ $tugas->deskripsi ?? 'Kerjakan tugas ini sesuai instruksi yang diberikan guru.' }}
                    </p>
        ...
        <div class="lg:col-span-2 space-y-6">
            <section class="bg-white rounded-[28px] border border-slate-200 shadow-lg p-6">
                ...
                <div class="rounded-2xl bg-slate-50 border border-slate-200 p-5 text-slate-700 leading-8 whitespace-pre-line">
                    {{ $tugas->deskripsi ?? 'Instruksi tugas belum tersedia.' }}
                </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div class="rounded-2xl bg-slate-50 border border-slate-200 p-5">
                            ...
                            <h4 class="text-lg font-extrabold text-slate-800">
                                {{ !empty($submission->created_at) ? \Carbon\Carbon::parse($submission->created_at)->format('d-m-Y H:i') : '-' }}
                            </h4>
                        </div>
                    ...
                    <form action="{{ route('siswa.tugas.submit', $tugas->id) }}"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Tulis jawaban atau catatan tugas di sini...">{{ old('jawaban') }}</textarea>
                        </div>
