    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
                ...
                <a href="{{ route('siswa.dashboard') }}" class="btn-dashboard">
                ...
                <div class="task-card">
                    <div class="task-top">
                        <div>
                            ...
                            <div class="task-desc">
                                {{ $item->deskripsi ? \Illuminate\Support\Str::limit($item->deskripsi, 110) : 'Kerjakan tugas ini sesuai instruksi yang diberikan guru.' }}
                            </div>
                        </div>
                    ...
                    <div class="task-info">
                        <div class="info-box">
                            ...
                            <div class="info-value">
                                @if($deadline)
                                    {{ $deadline->translatedFormat('d F Y') }}<br>
                                    {{ $deadline->format('H:i') }}
                                @else
                                    -
                                @endif
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-value">
                                {{ $isSubmitted ? 'Tugas sudah dikumpulkan' : ($isExpired ? 'Melewati batas pengumpulan' : 'Menunggu pengumpulan') }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="task-footer">
                        <a href="{{ route('siswa.tugas.show', $item->id) }}" class="btn-task btn-primary-task">
                            <i class="fas fa-folder-open"></i> Buka Tugas
                        </a>

                        @if($isSubmitted)
                            <a href="{{ route('siswa.tugas.show', $item->id) }}" class="btn-task btn-secondary-task">
