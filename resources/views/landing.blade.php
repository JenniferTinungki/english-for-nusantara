...
@section('title', 'English for Nusantara | SMP Negeri 8 Bitung')
...
<div class="min-h-screen bg-white text-slate-900 selection:bg-yellow-300/70 selection:text-blue-950">
    <nav class="fixed inset-x-0 top-0 z-50 border-b border-white/20 bg-white/85 backdrop-blur-xl">
        <div class="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-10">
            ...
            <div class="flex items-center gap-3">
                <a
                    href="#fitur"
                    class="hidden rounded-2xl border border-slate-200 px-5 py-3 text-sm font-bold text-slate-700 transition hover:border-blue-200 hover:bg-blue-50 hover:text-blue-800 sm:inline-flex"
                >
                    Jelajahi Fitur
                </a>
                ...
                <a
                    href="{{ url('/login') }}"
                    class="inline-flex items-center justify-center rounded-2xl bg-yellow-400 px-6 py-3 text-sm font-black text-blue-950 shadow-lg shadow-yellow-400/25 transition hover:-translate-y-0.5 hover:bg-yellow-300 hover:shadow-xl"
                >
                    Masuk
                </a>
            </div>
        ...
        <div class="relative mx-auto grid max-w-7xl gap-16 px-6 pb-24 lg:grid-cols-[1.08fr_0.92fr] lg:px-10">
            <div class="flex flex-col justify-center">
                ...
                <div class="mt-9 flex flex-col gap-4 sm:flex-row">
                    <a
                        href="{{ url('/login') }}"
                        class="inline-flex items-center justify-center rounded-2xl bg-yellow-400 px-7 py-4 text-base font-black text-blue-950 shadow-xl shadow-yellow-400/20 transition hover:-translate-y-0.5 hover:bg-yellow-300"
                    >
                        Mulai Sekarang
                    </a>
                    ...
                    <a
                        href="#guru"
                        class="inline-flex items-center justify-center rounded-2xl border border-white/20 bg-white/10 px-7 py-4 text-base font-bold text-white backdrop-blur-sm transition hover:bg-white/15"
                    >
                        Lihat Dukungan Guru
                    </a>
                </div>
    ...
    <section class="relative -mt-8 pb-4">
        <div class="mx-auto grid max-w-6xl gap-4 px-6 lg:grid-cols-4 lg:px-10">
            <div class="rounded-3xl border border-slate-200 bg-white p-6 card-shadow">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-10">
            ...
            <div class="mt-14 grid gap-8 md:grid-cols-2 xl:grid-cols-4">
                <div class="group rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <h3 class="mt-6 text-2xl font-black text-blue-950">Materi per Chapter</h3>
                    <p class="mt-4 leading-7 text-slate-600">
                        Konten belajar diatur mengikuti struktur <em>English for Nusantara</em> agar mudah dipahami, diajarkan, dan diakses kembali.
                    </p>
                </div>

                <div class="group rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    <div class="flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-700 text-white shadow-md transition group-hover:bg-yellow-400 group-hover:text-blue-950">
                        <i class="fa-solid fa-headphones-simple text-lg"></i>
                    </div>
                    <h3 class="mt-6 text-2xl font-black text-blue-950">Listening & Speaking</h3>
                    <p class="mt-4 leading-7 text-slate-600">
                        Mendukung latihan mendengar dan berbicara agar pembelajaran tidak hanya membaca, tetapi juga komunikatif dan aktif.
                    </p>
                </div>
                ...
                <div class="group rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <h3 class="mt-6 text-2xl font-black text-blue-950">Worksheet & Quiz</h3>
                    <p class="mt-4 leading-7 text-slate-600">
                        LKPD, latihan, dan quiz interaktif untuk memperkuat pemahaman vocabulary, grammar, reading, dan writing.
                    </p>
                </div>
                ...
                <div class="group rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <h3 class="mt-6 text-2xl font-black text-blue-950">Evaluasi Terstruktur</h3>
                    <p class="mt-4 leading-7 text-slate-600">
                        Penilaian formatif yang membantu guru memantau progres belajar siswa secara lebih cepat dan terarah.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="grid gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                <div>
                    ...
                    <div class="mt-8 space-y-4">
                        <div class="flex gap-4 rounded-3xl border border-slate-200 bg-slate-50 p-5">
                            <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-blue-700 font-black text-white">1</div>
                            <div>
                                <h3 class="text-lg font-black text-slate-900">Vocabulary & Warm-up</h3>
                                <p class="mt-1 text-slate-600">Pembuka materi yang memudahkan siswa memahami topik sebelum masuk ke inti pelajaran.</p>
                            </div>
                        </div>

                        <div class="flex gap-4 rounded-3xl border border-slate-200 bg-slate-50 p-5">
                            <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-blue-700 font-black text-white">2</div>
                            <div>
                                <h3 class="text-lg font-black text-slate-900">Reading, Listening, Speaking</h3>
                                <p class="mt-1 text-slate-600">Aktivitas inti yang membantu siswa berlatih memahami dan menggunakan bahasa Inggris secara aktif.</p>
                            </div>
                        </div>

                        <div class="flex gap-4 rounded-3xl border border-slate-200 bg-slate-50 p-5">
                            <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-blue-700 font-black text-white">3</div>
                            <div>
                                <h3 class="text-lg font-black text-slate-900">Practice & Assessment</h3>
                                <p class="mt-1 text-slate-600">Latihan dan evaluasi untuk mengukur perkembangan siswa dengan lebih sistematis.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    ...
                    <div class="rounded-[2rem] border border-dashed border-blue-200 bg-blue-950 p-7 text-white shadow-xl shadow-blue-950/10">
                        ...
                        <p class="mt-4 leading-7 text-blue-100">Bagian ini bisa dikembangkan menjadi grid chapter, carousel materi, atau preview menu agar landing page terlihat benar-benar siap produksi.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-10">
            ...
            <div class="mt-14 grid gap-8 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    <div class="h-80 flex items-center justify-center bg-gradient-to-br from-blue-600 to-blue-900">
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-28 h-28 rounded-full bg-white/20 border-4 border-white/40 flex items-center justify-center shadow-xl">
                                <span class="text-4xl font-black text-white">ILD</span>
                            </div>
                            <div class="w-16 h-1 rounded-full bg-white/40"></div>
                        </div>
                    </div>
                    <div class="p-6 text-center">
                        <h3 class="text-lg font-black text-slate-950">Ika Lestari Damayanti</h3>
                        <p class="mt-2 text-sm font-bold text-blue-700">Penulis Utama</p>
                        <p class="mt-3 text-sm leading-6 text-slate-500">Pakar pendidikan bahasa Inggris dan literasi anak.</p>
                    </div>
                </div>

                {{-- Penulis 2 --}}
                <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    <div class="h-80 flex items-center justify-center bg-gradient-to-br from-emerald-500 to-emerald-800">
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-28 h-28 rounded-full bg-white/20 border-4 border-white/40 flex items-center justify-center shadow-xl">
                                <span class="text-4xl font-black text-white">YF</span>
                            </div>
                            <div class="w-16 h-1 rounded-full bg-white/40"></div>
                        </div>
                    </div>
                    <div class="p-6 text-center">
                        <h3 class="text-lg font-black text-slate-950">Yusnita Febrianti</h3>
                        <p class="mt-2 text-sm font-bold text-emerald-600">Tim Penulis</p>
                        <p class="mt-3 text-sm leading-6 text-slate-500">Pengembang kurikulum dan materi pembelajaran interaktif.</p>
                    </div>
                </div>

                {{-- Penulis 3 --}}
                <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    <div class="h-80 flex items-center justify-center bg-gradient-to-br from-amber-500 to-amber-700">
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-28 h-28 rounded-full bg-white/20 border-4 border-white/40 flex items-center justify-center shadow-xl">
                                <span class="text-4xl font-black text-white">IN</span>
                            </div>
                            <div class="w-16 h-1 rounded-full bg-white/40"></div>
                        </div>
                    </div>
                    <div class="p-6 text-center">
                        <h3 class="text-lg font-black text-slate-950">Iyen Nurlaelawati</h3>
                        <p class="mt-2 text-sm font-bold text-amber-600">Tim Penulis</p>
                        <p class="mt-3 text-sm leading-6 text-slate-500">Ahli metodologi pembelajaran kreatif dan kontekstual.</p>
                    </div>
                </div>

                {{-- Penulis 4 --}}
                <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    <div class="h-80 flex items-center justify-center bg-gradient-to-br from-rose-500 to-rose-800">
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-28 h-28 rounded-full bg-white/20 border-4 border-white/40 flex items-center justify-center shadow-xl">
                                <span class="text-4xl font-black text-white">PP</span>
                            </div>
                            <div class="w-16 h-1 rounded-full bg-white/40"></div>
                        </div>
                    </div>
                    <div class="p-6 text-center">
                        <h3 class="text-lg font-black text-slate-950">Pipit Priwanda</h3>
                        <p class="mt-2 text-sm font-bold text-rose-600">Tim Penulis</p>
                        <p class="mt-3 text-sm leading-6 text-slate-500">Integrasi teknologi dalam pembelajaran bahasa Inggris modern.</p>
                    </div>
                </div>
        ...
        <div class="relative mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[1fr_0.95fr] lg:px-10">
            <div>
                ...
                <div class="mt-8 grid gap-4 sm:grid-cols-2">
                    <div class="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-md">
                        <div class="flex items-start gap-3">
                            <span class="mt-1 flex h-8 w-8 items-center justify-center rounded-full bg-yellow-400 font-black text-blue-950">✓</span>
                            <div>
                                <h3 class="font-black">Materi sesuai chapter</h3>
                                <p class="mt-1 text-sm leading-6 text-blue-100">Guru lebih mudah menyesuaikan pembelajaran dengan buku utama.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-md">
                        <div class="flex items-start gap-3">
                            <span class="mt-1 flex h-8 w-8 items-center justify-center rounded-full bg-yellow-400 font-black text-blue-950">✓</span>
                            <div>
                                <h3 class="font-black">Worksheet & LKPD</h3>
                                <p class="mt-1 text-sm leading-6 text-blue-100">Bahan ajar siap pakai untuk aktivitas kelas dan tugas siswa.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-md">
                        <div class="flex items-start gap-3">
                            <span class="mt-1 flex h-8 w-8 items-center justify-center rounded-full bg-yellow-400 font-black text-blue-950">✓</span>
                            <div>
                                <h3 class="font-black">Listening & speaking support</h3>
                                <p class="mt-1 text-sm leading-6 text-blue-100">Membantu guru menghadirkan pembelajaran yang lebih aktif dan komunikatif.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-md">
                        <div class="flex items-start gap-3">
                            <span class="mt-1 flex h-8 w-8 items-center justify-center rounded-full bg-yellow-400 font-black text-blue-950">✓</span>
                            <div>
                                <h3 class="font-black">Evaluasi lebih terarah</h3>
                                <p class="mt-1 text-sm leading-6 text-blue-100">Mempermudah guru memantau pemahaman siswa setelah pembelajaran.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 flex flex-col gap-4 sm:flex-row">
                    <a href="{{ url('/login') }}" class="inline-flex items-center justify-center rounded-2xl bg-yellow-400 px-6 py-4 font-black text-blue-950 shadow-xl shadow-yellow-400/20 transition hover:-translate-y-0.5 hover:bg-yellow-300">
                        Masuk Sebagai Guru
                    </a>
            ...
            <div class="relative">
                ...
                <div class="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/10 p-4 shadow-2xl backdrop-blur-md">
                    <img
                        src="{{ asset('images/SirAlberto.jpeg') }}"
                    ...
                    <div class="absolute bottom-8 left-8 right-8 rounded-[1.5rem] border border-white/15 bg-slate-950/50 p-5 backdrop-blur-md">
                        ...
                        <p class="mt-2 text-sm leading-6 text-blue-100">
                            Sir. Alberto Takaliuang, S.Pd, GR
                        </p>
                    </div>
                </div>
            </div>
    ...
    <footer class="bg-slate-950 text-slate-300">
        ...
        <div class="border-t border-slate-800 px-6 py-6 text-center text-sm text-slate-500 lg:px-10">
            &copy; {{ date('Y') }} English for Nusantara — SMP Negeri 8 Bitung. All rights reserved.
        </div>
    </footer>
</div>
@endsection