...
<div class="min-h-screen bg-white text-slate-900 selection:bg-yellow-300/70 selection:text-blue-950">
    <nav class="fixed inset-x-0 top-0 z-50 border-b border-white/20 bg-white/85 backdrop-blur-xl">
        <div class="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-10">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ url('/login') }}" class="inline-flex items-center justify-center rounded-2xl bg-yellow-400 px-6 py-3 text-sm font-black text-blue-950 shadow-lg shadow-yellow-400/25 transition hover:-translate-y-0.5 hover:bg-yellow-300 hover:shadow-xl">
                    Masuk
                </a>
            </div>
        </div>
        ...
        <div class="relative mx-auto grid max-w-7xl gap-16 px-6 pb-24 lg:grid-cols-[1.08fr_0.92fr] lg:px-10">
            <div class="flex flex-col justify-center">
                ...
                <div class="mt-9 flex flex-col gap-4 sm:flex-row">
                    <a href="{{ url('/login') }}" class="inline-flex items-center justify-center rounded-2xl bg-yellow-400 px-7 py-4 text-base font-black text-blue-950 shadow-xl shadow-yellow-400/20 transition hover:-translate-y-0.5 hover:bg-yellow-300">
                        Mulai Sekarang
                    </a>
            ...
            <div class="mt-14 grid gap-8 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="group rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    <div class="flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-700 text-white shadow-md transition group-hover:bg-yellow-400 group-hover:text-blue-950">
                        <i class="fa-solid {{ $fitur['icon'] }} text-lg"></i>
                    </div>
                    <h3 class="mt-6 text-2xl font-black text-blue-950">{{ $fitur['title'] }}</h3>
                    <p class="mt-4 leading-7 text-slate-600">{!! $fitur['desc'] !!}</p>
                </div>
                @endforeach
            </div>
        </div>
                ...
                <div>
                    ...
                    <div class="mt-8 space-y-4">
                        ...
                        <div class="flex gap-4 rounded-3xl border border-slate-200 bg-slate-50 p-5">
                            <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-blue-700 font-black text-white">{{ $step['num'] }}</div>
                            <div>
    ...
    {{-- ================================================================ --}}
    {{-- SECTION PENULIS — avatar inisial, tanpa butuh file foto          --}}
    {{-- ================================================================ --}}
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-10">
            ...
            <div class="mt-14 grid gap-8 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    {{-- Area foto: coba load gambar, fallback ke avatar inisial --}}
                    <div class="relative h-72 overflow-hidden bg-gradient-to-br {{ $p['warna'] }}">

                        {{-- Avatar inisial (selalu ada di belakang) --}}
                        <div class="absolute inset-0 flex flex-col items-center justify-center">
                            <div class="flex h-28 w-28 items-center justify-center rounded-full bg-white/20 border-4 border-white/30">
                                <span class="text-4xl font-black text-white">{{ $p['initial'] }}</span>
                            </div>
                            <p class="mt-4 text-sm font-semibold text-white/70">{{ $p['peran'] }}</p>
                        </div>

                        {{-- Foto di atas avatar — hidden otomatis jika gagal load --}}
                        <img
                            src="{{ asset($p['foto']) }}"
                            alt="{{ $p['nama'] }}"
                    ...
                    <div class="p-6 text-center">
                        <h3 class="text-lg font-black text-slate-950">{{ $p['nama'] }}</h3>
                        <p class="mt-2 text-sm font-bold {{ $p['badge'] }}">{{ $p['peran'] }}</p>
                    ...
                    <div class="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-md">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm leading-6 text-blue-100">{{ $item['desc'] }}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
