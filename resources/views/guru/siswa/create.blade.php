...
<div class="page-shell">
    ...
    <div class="mb-4">
        ...
        <h1 class="fw-bold mt-2" style="font-size:2rem;color:#102040;">Tambah Siswa Baru</h1>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-3 p-4 p-lg-5">
        <form action="{{ route('guru.siswa.store') }}" method="POST">
            ...
            <div class="row g-4 mb-5">
                ...
                <div class="col-md-6">
                    <label class="fw-semibold mb-2">Password <span class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                    <label class="fw-semibold mb-2">Konfirmasi Password <span class="text-danger">*</span></label>
                    <div class="input-group">
