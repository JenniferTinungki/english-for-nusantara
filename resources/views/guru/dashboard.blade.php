            ...
            <div class="glass-card p-4 p-lg-5 h-100" style="background: linear-gradient(135deg, #2451e6 0%, #5b4df1 100%); color: white;">
                <div class="d-flex flex-column h-100 justify-content-between">
                    ...
                    <div class="d-flex flex-wrap gap-3 mt-4">
                        <a href="{{ route('guru.materi.create') }}" class="btn-premium" style="background: white; color: #2049da;">
                            + Tambah Materi
                        </a>
                        <a href="{{ route('guru.tugas.create') }}" class="btn-soft" style="background: rgba(255,255,255,0.12); border-color: rgba(255,255,255,0.2); color: white;">
                            + Tambah Tugas
                        </a>
                    </div>
                </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-sm-6 col-xl-3">
            <div class="glass-card-strong p-4 h-100">
                ...
                <div style="font-size:2.4rem; font-weight:800; margin-top:10px;">{{ $totalMateri ?? 0 }}</div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="glass-card-strong p-4 h-100">
                ...
                <div style="font-size:2.4rem; font-weight:800; margin-top:10px;">{{ $totalTugas ?? 0 }}</div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="glass-card-strong p-4 h-100">
                ...
                <div style="font-size:2.4rem; font-weight:800; margin-top:10px;">{{ $totalSubmit ?? 0 }}</div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="glass-card-strong p-4 h-100">
                ...
                <div style="font-size:2.4rem; font-weight:800; margin-top:10px;">{{ $totalSiswa ?? 0 }}</div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-8">
            <div class="glass-card-strong p-4 p-lg-5 h-100">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('guru.tugas.index') }}" class="btn-soft">Lihat Semua</a>
                </div>

                @if(isset($tugasTerbaru) && count($tugasTerbaru))
                    <div class="d-flex flex-column gap-3">
                        @foreach($tugasTerbaru as $tugas)
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 p-4"
                                ...
                                <a href="{{ route('guru.tugas.show', $tugas->id) }}" class="btn-premium">
                                    Detail
                                </a>
                            </div>
                        @endforeach
        ...
        <div class="col-xl-4">
            <div class="glass-card-strong p-4 p-lg-5 h-100">
                ...
                <div class="d-grid gap-3">
                    ...
                    <a href="{{ route('guru.materi.index') }}" class="btn-soft">
                        Kelola Materi
                    </a>

                    <a href="{{ route('guru.tugas.index') }}" class="btn-soft">
                        Kelola Tugas
                    </a>
                </div>
            </div>
