    ...
    <aside id="adminSidebar" class="w-72 fixed inset-y-0 left-0 z-50 transition-transform duration-300 lg:translate-x-0 -translate-x-full lg:static">
        <div class="h-full glass-card m-4 rounded-[2.5rem] p-6 flex flex-col">
            ...
            <nav class="flex-1 space-y-2 overflow-y-auto pr-2 custom-scrollbar">
                ...
                <a href="<?php echo e(route('admin.materi.index')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all <?php echo e(request()->routeIs('admin.materi.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-200' : 'text-slate-600 hover:bg-blue-50 hover:text-blue-600'); ?>">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg <?php echo e(request()->routeIs('admin.materi.*') ? 'bg-white/20' : 'bg-slate-100'); ?>">
                ...
                <div>
                    ...
                    <div id="menu-data-siswa" class="submenu <?php echo e(request()->routeIs('admin.users.*') ? 'open' : ''); ?> pl-12 mt-1 space-y-1">
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="block py-2 text-sm <?php echo e(request()->routeIs('admin.users.index') ? 'text-blue-600 font-bold' : 'text-slate-500 hover:text-blue-600'); ?>">Daftar Siswa</a>
                        <a href="<?php echo e(route('admin.users.create')); ?>" class="block py-2 text-sm <?php echo e(request()->routeIs('admin.users.create') ? 'text-blue-600 font-bold' : 'text-slate-500 hover:text-blue-600'); ?>">Tambah Siswa</a>
                    </div>
                </div>

                
                <a href="<?php echo e(route('admin.quiz-evaluasi.index')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all <?php echo e(request()->routeIs('admin.quiz-evaluasi.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-200' : 'text-slate-600 hover:bg-blue-50 hover:text-blue-600'); ?>">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg <?php echo e(request()->routeIs('admin.quiz-evaluasi.*') ? 'bg-white/20' : 'bg-slate-100'); ?>">
                ...
                <a href="<?php echo e(url('/admin/laporan')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all <?php echo e(request()->routeIs('admin.laporan.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-200' : 'text-slate-600 hover:bg-blue-50 hover:text-blue-600'); ?>">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg <?php echo e(request()->routeIs('admin.laporan.*') ? 'bg-white/20' : 'bg-slate-100'); ?>">
...
</html><?php /**PATH /home/u748564652/domains/englishfornusantara.com/proyek-pertama-saya/resources/views/layouts/admin.blade.php ENDPATH**/ ?>