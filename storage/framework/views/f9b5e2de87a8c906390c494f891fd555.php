...
<div class="page-shell">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <?php if($assessment->questions->where('type', 'essay')->count() > 0): ?>
                <a href="<?php echo e(route('guru.assessment.essay.list', $assessment->id)); ?>" class="btn btn-warning rounded-pill px-4 fw-bold">
                    ...
                    <div>
                        ...
                        <div class="d-flex gap-2">
                            <span class="badge bg-primary rounded-pill px-3">
                                PG: <?php echo e($assessment->questions->where('type', 'pilihan_ganda')->count()); ?>

                            </span>
                            <span class="badge bg-warning text-dark rounded-pill px-3">
                                Essay: <?php echo e($assessment->questions->where('type', 'essay')->count()); ?>
        ...
        <?php if($assessment->questions->count()): ?>
            <div class="d-flex flex-column gap-3">
                <?php $__currentLoopData = $assessment->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $type = $question->type ?? 'pilihan_ganda'; ?>
                    <div class="glass-card p-4">
                        <div class="d-flex justify-content-between align-items-start gap-3 flex-wrap">
                            <div style="flex:1;">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    <span class="fw-bold text-muted">Soal <?php echo e($index + 1); ?></span>
                                    <?php if($type === 'essay'): ?>
                                        ...
                                        <?php $__currentLoopData = ['a','b','c','d']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-6">
                                                <div class="rounded-3 px-3 py-2 d-flex align-items-center gap-2
                                                    <?php echo e(strtolower($question->correct_answer ?? '') === $opt ? 'bg-success bg-opacity-10 border border-success' : 'bg-light border'); ?>">
                                                    <span class="fw-bold <?php echo e(strtolower($question->correct_answer ?? '') === $opt ? 'text-success' : 'text-muted'); ?>">
                                                        <?php echo e(strtoupper($opt)); ?>.
                                                    </span>
                                                    <span class="<?php echo e(strtolower($question->correct_answer ?? '') === $opt ? 'text-success fw-semibold' : 'text-dark'); ?>">
                                                        <?php echo e($question->{'option_' . $opt}); ?>

                                                    </span>
                                                    <?php if(strtolower($question->correct_answer ?? '') === $opt): ?>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u748564652/domains/englishfornusantara.com/proyek-pertama-saya/resources/views/guru/assessment/show.blade.php ENDPATH**/ ?>