    ...
    <div class="question-card">
        <div class="question-top">
            <div class="question-left">
                ...
                <div>
                    <div class="question-title"><?php echo e($question->question); ?></div>
                    <div class="question-meta">
                        <?php if(($question->type ?? 'pilihan_ganda') === 'essay'): ?>
        ...
        <?php if(($question->type ?? 'pilihan_ganda') === 'essay'): ?>
            <div class="mt-3">
                <textarea
                    name="essay[<?php echo e($question->id); ?>]"
                    rows="4"
                    class="form-control rounded-3"
                    placeholder="Tulis jawaban essay kamu di sini..."><?php echo e(old("essay.{$question->id}")); ?></textarea>
            </div>
        <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u748564652/domains/englishfornusantara.com/proyek-pertama-saya/resources/views/siswa/assessment/show.blade.php ENDPATH**/ ?>