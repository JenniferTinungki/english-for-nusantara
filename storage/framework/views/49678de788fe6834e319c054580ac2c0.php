            ...
            <div class="px-4 py-5 overflow-y-auto flex-1">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="<?php echo e(url('/admin/dashboard')); ?>"
                       ...
                       <?php echo e(request()->is('admin/dashboard') ? 'bg-white text-blue-700 shadow-lg' : 'text-white/90 hover:bg-white/10 hover:text-white'); ?>">
                        <i class="fa-solid fa-house w-5 text-center"></i>
                        <span>Dashboard</span>
                    </a>

                    
                    <div x-data="{ open: <?php echo e(request()->routeIs('admin.materi.*') ? 'true' : 'false'); ?> }">
                        <button @click="open = !open"
                            class="w-full flex items-center justify-between rounded-2xl px-4 py-3 font-semibold transition
                            <?php echo e(request()->routeIs('admin.materi.*') ? 'bg-white/20' : 'text-white/90 hover:bg-white/10 hover:text-white'); ?>">
                            <div class="flex items-center gap-3">
                        ...
                        <div x-show="open" x-transition.opacity
                            ...
                            <a href="<?php echo e(route('admin.materi.index')); ?>"
                               class="block text-sm transition-colors <?php echo e(request()->routeIs('admin.materi.index') ? 'text-white font-bold' : 'text-blue-200 hover:text-white'); ?>">
                                Daftar Materi
                            </a>
                            <a href="<?php echo e(route('admin.materi.create')); ?>"
                               class="block text-sm transition-colors <?php echo e(request()->routeIs('admin.materi.create') ? 'text-white font-bold' : 'text-blue-200 hover:text-white'); ?>">
                                Tambah Materi
                            </a>
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: <?php echo e(request()->routeIs('admin.users.*') ? 'true' : 'false'); ?> }">
                        <button @click="open = !open"
                            ...
                            <?php echo e(request()->routeIs('admin.users.*') ? 'bg-white/20' : 'text-white/90 hover:bg-white/10 hover:text-white'); ?>">
                            <div class="flex items-center gap-3">
                        ...
                        <div x-show="open" x-transition.opacity
                            ...
                            <a href="<?php echo e(route('admin.users.index')); ?>"
                               class="block text-sm transition-colors <?php echo e(request()->routeIs('admin.users.index') ? 'text-white font-bold' : 'text-blue-200 hover:text-white'); ?>">
                                Daftar Siswa
                            </a>
                            <a href="<?php echo e(route('admin.users.create')); ?>"
                               class="block text-sm transition-colors <?php echo e(request()->routeIs('admin.users.create') ? 'text-white font-bold' : 'text-blue-200 hover:text-white'); ?>">
                                Tambah Siswa
                            </a>
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: <?php echo e(request()->routeIs('admin.quiz-evaluasi.*') ? 'true' : 'false'); ?> }">
                        <a href="<?php echo e(route('admin.quiz-evaluasi.index')); ?>"
                            class="w-full flex items-center justify-between px-4 py-3 rounded-2xl transition
                            <?php echo e(request()->routeIs('admin.quiz-evaluasi.*') ? 'bg-white/20' : 'text-white/90 hover:bg-white/10 hover:text-white'); ?>">
                            <div class="flex items-center gap-3">
                        ...
                        <div x-show="open" x-transition.opacity
                             class="pl-12 pr-4 py-2 space-y-3 mt-1"
                             style="<?php echo e(request()->routeIs('admin.quiz-evaluasi.*') ? '' : 'display: none;'); ?>">
                            <a href="<?php echo e(route('admin.quiz-evaluasi.index')); ?>"
                               class="block text-sm transition-colors <?php echo e(request()->routeIs('admin.quiz-evaluasi.index') ? 'text-white font-bold' : 'text-blue-200 hover:text-white'); ?>">
                                Rekap Quiz
                            </a>
                            <a href="<?php echo e(route('admin.quiz-evaluasi.hasil')); ?>"
                               class="block text-sm transition-colors <?php echo e(request()->routeIs('admin.quiz-evaluasi.hasil') ? 'text-white font-bold' : 'text-blue-200 hover:text-white'); ?>">
                                Hasil Siswa
                            </a>
                            <a href="<?php echo e(route('admin.quiz-evaluasi.leaderboard')); ?>"
                               class="block text-sm transition-colors <?php echo e(request()->routeIs('admin.quiz-evaluasi.leaderboard') ? 'text-white font-bold' : 'text-blue-200 hover:text-white'); ?>">
                                🏆 Leaderboard
                            </a>
                        </div>
                    </div>
                    ...
                    <a href="<?php echo e(url('/admin/laporan')); ?>"
                       class="flex items-center gap-3 rounded-2xl px-4 py-3 font-semibold transition
                       <?php echo e(request()->is('admin/laporan*') ? 'bg-white text-blue-700 shadow-lg' : 'text-white/90 hover:bg-white/10 hover:text-white'); ?>">
...
</div><?php /**PATH C:\Users\USER\Documents\proyek-pertama-saya\resources\views\layouts\sidebar-admin.blade.php ENDPATH**/ ?>