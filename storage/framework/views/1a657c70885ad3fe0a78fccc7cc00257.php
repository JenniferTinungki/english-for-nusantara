    ...
    <div class="flex-1 min-h-screen lg:ml-[260px]">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="flex items-center gap-3">
                            <div class="hidden md:block text-right">
                                <p class="text-white font-semibold leading-tight"><?php echo e(Auth::user()->name); ?></p>
                                <p class="text-blue-100 text-sm capitalize"><?php echo e(Auth::user()->role); ?></p>
                            </div>
        ...
        <main class="px-4 sm:px-6 lg:px-8 pt-0 pb-8 fadein" id="main-content">
            <?php if(session('success')): ?>
                <div class="mb-4 px-4 py-3 rounded-xl bg-green-100 text-green-700"><?php echo e(session('success')); ?></div>
            <?php endif; ?>
            <?php if(session('error')): ?>
                <div class="mb-4 px-4 py-3 rounded-xl bg-red-100 text-red-700"><?php echo e(session('error')); ?></div>
            <?php endif; ?>
            <?php if($errors->any()): ?>
...
</html><?php /**PATH /home/u748564652/domains/englishfornusantara.com/proyek-pertama-saya/resources/views/layouts/app.blade.php ENDPATH**/ ?>