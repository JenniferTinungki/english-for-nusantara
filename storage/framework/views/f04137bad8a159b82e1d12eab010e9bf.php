...
<div class="page-shell">
    <div class="glass-card-strong p-5 mx-auto" style="max-width:1000px;">
        ...
        <form action="<?php echo e(route('guru.quiz.questions.store', $quiz->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>

            <div class="mb-4">
                <label class="form-label fw-semibold">Pertanyaan</label>
                <textarea name="question" rows="4" class="form-control" required><?php echo e(old('question')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="option_a" class="form-control" value="<?php echo e(old('option_a')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="option_b" class="form-control" value="<?php echo e(old('option_b')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="option_c" class="form-control" value="<?php echo e(old('option_c')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="option_d" class="form-control" value="<?php echo e(old('option_d')); ?>" required>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\proyek-pertama-saya\resources\views\guru\quiz\questions\create.blade.php ENDPATH**/ ?>