...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-slate-500 font-medium">Mengubah data: <span class="text-blue-600"><?php echo e($user->name); ?></span></p>
    </div>
...
unset($__errorArgs, $__bag); ?> rounded-xl focus:ring-2 focus:border-transparent transition-all outline-none"
                        value="<?php echo e(old('name', $user->name)); ?>" placeholder="Nama lengkap siswa">
...
unset($__errorArgs, $__bag); ?> rounded-xl focus:ring-2 focus:border-transparent transition-all outline-none"
                        value="<?php echo e(old('nis', $user->nis)); ?>" placeholder="Nomor Induk Siswa">
                    <?php $__errorArgs = ['nis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?> rounded-xl focus:ring-2 focus:border-transparent transition-all outline-none"
                        value="<?php echo e(old('kelas', $user->kelas)); ?>" placeholder="Contoh: X IPA 1">
...
unset($__errorArgs, $__bag); ?> rounded-xl focus:ring-2 focus:border-transparent transition-all outline-none appearance-none cursor-pointer">
                            ...
                            <option value="L" <?php if(old('jenis_kelamin', $user->jenis_kelamin) === 'L'): echo 'selected'; endif; ?>>Laki-laki</option>
                            <option value="P" <?php if(old('jenis_kelamin', $user->jenis_kelamin) === 'P'): echo 'selected'; endif; ?>>Perempuan</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-4 flex items-center md:items-end pb-2 md:pb-1">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="is_active" id="is_active" value="1" class="sr-only peer" <?php if(old('is_active', $user->is_active)): echo 'checked'; endif; ?>>
...
unset($__errorArgs, $__bag); ?> rounded-xl focus:ring-2 focus:border-transparent transition-all outline-none"
                        value="<?php echo e(old('username', $user->username)); ?>" placeholder="Username untuk login">
...
unset($__errorArgs, $__bag); ?> rounded-xl focus:ring-2 focus:border-transparent transition-all outline-none"
                        value="<?php echo e(old('email', $user->email)); ?>" placeholder="email@siswa.sch.id">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-12">
                    <p class="text-xs font-medium text-amber-600 bg-amber-50 px-4 py-2 rounded-lg inline-block border border-amber-100">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\proyek-pertama-saya\resources\views\admin\users\edit.blade.php ENDPATH**/ ?>