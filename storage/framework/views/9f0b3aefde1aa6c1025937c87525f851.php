<?php $__env->startSection('title', 'Login - English for Nusantara'); ?>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="flex items-center gap-4 mb-8">
                    <div class="w-16 h-16 rounded-2xl bg-white flex items-center justify-center shadow-md border border-slate-200 overflow-hidden shrink-0">
                        <img src="<?php echo e(asset('images/kemendikbud.jpg')); ?>" alt="Logo" class="w-11 h-11 object-contain">
                    </div>
                    <div>
        ...
        <div class="relative hidden lg:flex items-center justify-center bg-gradient-to-b from-blue-950 via-blue-800 to-blue-700 p-8 xl:p-10 overflow-hidden">
            ...
            <div class="relative z-10 w-full max-w-2xl">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <?php $__currentLoopData = ['login1.jpeg','login2.jpeg','login3.jpeg','login4.jpeg']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="overflow-hidden rounded-3xl border border-white/20 shadow-xl bg-white/10">
                        <img src="<?php echo e(asset('images/'.$img)); ?>" alt="Aktivitas sekolah"
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u748564652/domains/englishfornusantara.com/proyek-pertama-saya/resources/views/auth/login.blade.php ENDPATH**/ ?>