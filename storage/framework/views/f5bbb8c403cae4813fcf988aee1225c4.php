<div class="guru-sidebar">
    <div>
        ...
        <div class="guru-profile-card">
            ...
            <div>
                <h4><?php echo e(Auth::user()->name ?? 'Guru'); ?></h4>
                <span><?php echo e(ucfirst(Auth::user()->role ?? 'guru')); ?></span>
            </div>
        </div>
        ...
        <div class="sidebar-menu">
            <a href="<?php echo e(route('guru.dashboard')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('guru.dashboard') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('guru.materi.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('guru.materi.*') ? 'active' : ''); ?>">
                <span class="sidebar-icon">
            ...
            <a href="<?php echo e(route('guru.tugas.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('guru.tugas.*') ? 'active' : ''); ?>">
                <span class="sidebar-icon">
            ...
            <a href="<?php echo e(route('guru.quiz.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('guru.quiz.*') ? 'active' : ''); ?>">
                <span class="sidebar-icon">
            ...
            <a href="<?php echo e(route('guru.assessment.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('guru.assessment.*') ? 'active' : ''); ?>">
                <span class="sidebar-icon">
            ...
            <a href="<?php echo e(route('guru.siswa.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('guru.siswa.*') ? 'active' : ''); ?>">
                <span class="sidebar-icon">
            ...
            <a href="<?php echo e(route('guru.penilaian.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('guru.penilaian.*') ? 'active' : ''); ?>">
                <span class="sidebar-icon">
            ...
            <a href="<?php echo e(route('guru.progress.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('guru.progress.*') ? 'active' : ''); ?>">
                <span class="sidebar-icon">
...
</style><?php /**PATH /home/u748564652/domains/englishfornusantara.com/proyek-pertama-saya/resources/views/layouts/sidebar-guru.blade.php ENDPATH**/ ?>