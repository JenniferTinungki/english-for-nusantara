            ...
            <div class="mt-14 grid gap-8 sm:grid-cols-2 xl:grid-cols-4">
                <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    <div class="h-80 overflow-hidden">
                        <img src="<?php echo e(asset('images/ika.png')); ?>" alt="Ika Lestari Damayanti" class="h-full w-full object-cover transition duration-500 hover:scale-105">
                    </div>
                ...
                <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    <div class="h-80 overflow-hidden">
                        <img src="<?php echo e(asset('images/penulis/yusnita.jpg')); ?>" alt="Yusnita Febrianti" class="h-full w-full object-cover transition duration-500 hover:scale-105">
                    </div>
                    <div class="p-6 text-center">
                ...
                <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    <div class="h-80 overflow-hidden">
                        <img src="<?php echo e(asset('images/penulis/iyen.jpg')); ?>" alt="Iyen Nurlaelawati" class="h-full w-full object-cover transition duration-500 hover:scale-105">
                    </div>
                    <div class="p-6 text-center">
                ...
                <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    <div class="h-80 overflow-hidden">
                        <img src="<?php echo e(asset('images/penulis/pipit.jpg')); ?>" alt="Pipit Priwanda" class="h-full w-full object-cover transition duration-500 hover:scale-105">
                    </div>
                    <div class="p-6 text-center">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\proyek-pertama-saya\resources\views\landing.blade.php ENDPATH**/ ?>