                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div class="rounded-2xl bg-slate-50 border border-slate-200 p-5">
                            ...
                            <h4 class="text-lg font-extrabold text-slate-800">
                                <?php echo e(!empty($submission->created_at) ? $submission->created_at->format('d-m-Y H:i') : '-'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\proyek-pertama-saya\resources\views\siswa\quiz\show.blade.php ENDPATH**/ ?>