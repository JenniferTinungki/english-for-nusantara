...
<div class="page-shell">
    ...
    <div class="page-header mb-4">
        <h1>Edit Soal</h1>
        <p>Perbarui soal untuk assessment: <strong><?php echo e($assessment->title); ?></strong></p>
    </div>

    <div class="glass-card-strong p-4 p-lg-5">
        <form action="<?php echo e(route('guru.assessment.questions.update', [$assessment->id, $question->id])); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                    placeholder="Tulis pertanyaan di sini..."><?php echo e(old('question', $question->question)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                        placeholder="Isi pilihan A" value="<?php echo e(old('option_a', $question->option_a)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                        placeholder="Isi pilihan B" value="<?php echo e(old('option_b', $question->option_b)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                        placeholder="Isi pilihan C" value="<?php echo e(old('option_c', $question->option_c)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                        placeholder="Isi pilihan D" value="<?php echo e(old('option_d', $question->option_d)); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex flex-wrap gap-3">
                <button type="submit" class="btn-premium">Update Soal</button>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\proyek-pertama-saya\resources\views\guru\assessment\questions\edit.blade.php ENDPATH**/ ?>