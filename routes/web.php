...
Route::middleware('auth')
    ...
    ->group(function () {
        ...
        /*
        |------------------------------------
        | Materi + Sub Materi + Isi Detail
        |------------------------------------
        */
        Route::controller(GuruMateriController::class)
            ->prefix('materi')
            ->name('materi.')
            ->group(function () {
        ...
        |------------------------------------
        */
        Route::controller(GuruTugasController::class)
            ->prefix('tugas')
            ->name('tugas.')
            ->group(function () {
                Route::get('/', 'index')->name('index');
        ...
        Route::post('/tugas-submit/{id}/nilai', [GuruTugasController::class, 'nilai'])
            ->name('tugas.nilai');
        ...
        |------------------------------------
        */
        Route::controller(GuruQuizController::class)
            ->prefix('quiz')
            ->name('quiz.')
            ->group(function () {
                Route::get('/', 'index')->name('index');
        ...
        Route::controller(GuruQuizQuestionController::class)
            ->prefix('quiz/{quizId}/questions')
            ->name('quiz.questions.')
            ->group(function () {
                Route::get('/create', 'create')->name('create');
                Route::post('/', 'store')->name('store');
        ...
        |------------------------------------
        */
        Route::controller(GuruAssessmentController::class)
            ->prefix('assessment')
            ->name('assessment.')
            ->group(function () {
                Route::get('/', 'index')->name('index');
        ...
        Route::controller(GuruAssessmentQuestionController::class)
            ->prefix('assessment/{assessmentId}/questions')
        ...
        */
        ...
        |------------------------------------
        */
        Route::get('/progress', [GuruMonitoringProgressController::class, 'index'])
            ->name('progress.index');
    });
...
Route::middleware('auth')
    ...
    ->group(function () {
        ...
        */
        ...
        |------------------------------------
        */
        Route::controller(SiswaQuizController::class)
            ->prefix('quiz')
            ->name('quiz.')
            ->group(function () {
                Route::get('/', 'index')->name('index');
        ...
        |------------------------------------
        */
        Route::controller(SiswaTugasController::class)
            ->prefix('tugas')
            ->name('tugas.')
            ->group(function () {
                Route::get('/', 'index')->name('index');
        ...
        |------------------------------------
        */
        Route::controller(SiswaAssessmentController::class)
            ->prefix('assessment')
            ->name('assessment.')
            ->group(function () {
                Route::get('/', 'index')->name('index');
        ...
        |------------------------------------
        */
        Route::get('/progress', [SiswaProgressController::class, 'index'])
            ->name('progress.index');
    });